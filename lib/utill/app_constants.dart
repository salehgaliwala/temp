...
class AppConstants {
  static const String APP_NAME = 'XXXX';

  static const String BASE_URL = 'XXXX';
  ...
  static const String OTHER_PRODUCTS_URI =
      '/api/v1/products/other-customer-products/';
  static const String RECENT_PRODUCTS_URI = '/api/v1/products/recent-products/';
