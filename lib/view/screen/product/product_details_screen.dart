...
import 'package:flutter_sixvalley_ecommerce/view/screen/product/widget/recent_product_view.dart';
import 'package:flutter_sixvalley_ecommerce/view/screen/product/widget/other_product_view.dart';
...
class _ProductDetailsState extends State<ProductDetails> {
  _loadData(BuildContext context) async {
    String userID = await Provider.of<ProfileProvider>(context, listen: false)
        .getUserInfo(context);
    ...
    if (widget.banner) {
      ...
      Provider.of<ProductProvider>(context, listen: false)
          .initRecentProductList(userID, context);
      Provider.of<ProductProvider>(context, listen: false)
          .initOtherProductList(userID, context);
      Provider.of<ProductDetailsProvider>(context, listen: false)
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            TitleRow(
                                title:
                                    getTranslated('recent_products', context),
                                isDetailsPage: true),
                            SizedBox(height: 5),
                            RecentProductView(),
                          ],
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            TitleRow(
                                title: getTranslated('other_products', context),
                                isDetailsPage: true),
                            SizedBox(height: 5),
                            OtherProductView(),
                          ],
