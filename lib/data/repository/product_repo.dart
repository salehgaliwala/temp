...
class ProductRepo {
  ...
  Future<ApiResponse> getRecentProductList(String id) async {
    try {
      final response =
          await dioClient.get(AppConstants.RECENT_PRODUCTS_URI + id);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  Future<ApiResponse> getOtherProductList(String id) async {
    try {
      final response =
          await dioClient.get(AppConstants.OTHER_PRODUCTS_URI + id);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
